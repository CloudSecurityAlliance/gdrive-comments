...
**Last verified:** 2026-09-02 (v0.40.0)
...
- **Status:** production — feature-complete for its scoped roadmap and
  live-verified end-to-end against real Google. Current release **v0.40.0**;
...
- **Status:** **shipped**, v0.2.0 onward (2026-08-24); current release v0.40.0.
