...
**Last verified:** 2026-09-05 (v0.51.1)
...
- **Status:** production — feature-complete for its scoped roadmap and
  live-verified end-to-end against real Google. Current release **v0.51.1**;
...
- **Status:** **shipped**, v0.2.0 onward (2026-08-24); current release v0.51.1.
